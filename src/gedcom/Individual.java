...
public class Individual {
	...
	public void setBirthDate(String birthDate) {
		...
		LocalDate bdate = LocalDate.of(Integer.parseInt(birthDateSplitted[2]),
				Arrays.asList(month).indexOf(birthDateSplitted[1]) + 1, Integer.parseInt(birthDateSplitted[0]));
	...
	public void setDeathDate(String deathDate) {
		...
		LocalDate ddate = LocalDate.of(Integer.parseInt(deathDateSplitted[2]),
				Arrays.asList(month).indexOf(deathDateSplitted[1]) + 1, Integer.parseInt(deathDateSplitted[0]));
	...
	public int getAge() {
		...
		return this.deathDate == null ? Period.between(this.birthDate, today).getYears()
				: Period.between(this.birthDate, this.deathDate).getYears();
	}
