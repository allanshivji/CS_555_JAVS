...
@RunWith(Suite.class)
@SuiteClasses({ Test_CheckValidity.class, Test_DateCheck.class, Test_US05MarriageBeforeDeath.class,
		...
		Test_US24UniqueFamilyBySpouse.class, Test_US09BirthAfterDeathOfParents.class})
