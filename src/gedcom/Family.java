...
public class Family {
	...
	public void setMarriageDate(String marriageDate) {
		...
		LocalDate mdate = LocalDate.of(Integer.parseInt(marriageDateSplitted[2]),
				Arrays.asList(month).indexOf(marriageDateSplitted[1]) + 1, Integer.parseInt(marriageDateSplitted[0]));
	...
	public void setDivorceDate(String divorcedDate) {
		...
		LocalDate ddate = LocalDate.of(Integer.parseInt(divorcedDateSplitted[2]),
				Arrays.asList(month).indexOf(divorcedDateSplitted[1]) + 1, Integer.parseInt(divorcedDateSplitted[0]));
