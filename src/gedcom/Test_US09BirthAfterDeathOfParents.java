...
public class Test_US09BirthAfterDeathOfParents {
	...
	public void testBirthAfterDeathOfMother() {
		...
		error.setErrorDetails(
				"The birthdate 2018-02-24 of James Birt (I102) is after the death date 2016-03-10 of mother(I101)");
	...
	public void testBirthAfterDeathOfFather() {
		...
		error.setErrorDetails(
				"The birthdate 2015-10-02 of James Birt (I202) is nine months after the death date 2015-01-01 of father(I200)");
	...
	public void testBirthAfterDeathOfMotherFather() {
		...
		error.setErrorDetails(
				"The birthdate 2016-01-02 of James Birt (I302) is after the death date 2009-04-10 of mother(I301)");
		...
		error.setIndividualId("I302");
		error.setErrorDetails(
				"The birthdate 2016-01-02 of James Birt (I302) is nine months after the death date 2015-01-01 of father(I300)");
